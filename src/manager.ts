...
import GuildWelcomer from "./events/client/welcomer.js";
...
export class Manager extends Client {
  ...
  constructor() {
    ...
    this.color = (this.config.bot.EMBED_COLOR || "#ffffff") as ColorResolvable;
    this.i18n = new I18n({
    ...
    const guildMemberAddRemove = new GuildWelcomer();
    guildMemberAddRemove.execute(this);
